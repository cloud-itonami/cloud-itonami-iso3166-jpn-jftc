...
`cloud-itonami-iso3166-jpn-jftc` accepts contributions to the OSS actor, governor tests,
...
- Keep production actions behind the Antitrust Compliance Governor.
- Never let the advisor state a legal/tax conclusion as fact — every
  regulatory requirement must cite the official JFTC source.
